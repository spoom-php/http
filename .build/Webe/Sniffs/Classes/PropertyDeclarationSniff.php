...
class Webe_Sniffs_Classes_PropertyDeclarationSniff extends PHP_CodeSniffer_Standards_AbstractVariableSniff {
  ...
  protected function processMemberVar( PHP_CodeSniffer_File $phpcsFile, $stackPtr ) {
    ...
    if( $modifier[ 'code' ] === T_PUBLIC && $tokens[ $stackPtr ][ 'content' ][ 1 ] === '_' ) {

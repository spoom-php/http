...
class HttpMessageTest extends PHPUnit_Framework_TestCase {
  ...
  public function testRequest() {
    ...
    $uri     = Helper\Uri::instance( 'http://example.com/request/index.php?q=test2' );
    $request = new Message\Request( Helper\Uri::instance( 'http://example.com/request/index.php?q=test' ) );
    $request->setHeader( [

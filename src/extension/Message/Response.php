...
interface ResponseInterface extends MessageInterface {
   ...
   *
   * @return static
   * @throws \InvalidArgumentException Lower than zero input
   */
   ...
   * @return static
   */
  public function setCookie( string $name, $value = null, $expire = 0, array $option = [] );
}
/**
 * Class Response
 * @package Spoom\Http\Message
...
class Response extends Message implements ResponseInterface {
  ...
  //
  public function getReason(): string {
    return empty( $this->_reason ) && isset( static::REASON[ $this->_status ] ) ? static::REASON[ $this->_status ] : (string) $this->_reason;
  }
  //
  public function setReason( ?string $value ) {
  ...
  public function setStatus( int $value ) {
    ...
    if( $value < 0 ) throw new \InvalidArgumentException( "Status can't be lower than zero ({$value} given)" );
    else {
